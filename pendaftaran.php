            ...
            <form action="proses-pendaftaran.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="pilihan_jurusan">
                        <option value="Otomatisasi dan Tata Kelola Perkantoran">Ilmu Pengetahun Alam</option>
                        <option value="Desain Pemodelan dan Informasi Bangunan">Ilmu Pengetahun Sosial</option>
                    </select>
                </div>
